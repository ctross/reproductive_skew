########################### Set working directory and load required packages
 ...
 # basewd = 'C:\\Users\\cody_ross\\Dropbox\\Completed and Published Projects\\1-papers\\Reproductive Skew\\UpdatedWorkflow'
 setwd(basewd)
...
########################### Now merge final dataand then prune down to one point per species/group
